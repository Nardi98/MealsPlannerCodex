...
def test_accept_recipe_handles_duplicates(db_session):
    ...
    r1 = crud.create_recipe(db_session, title="Dup", servings_default=1, course="main course", score=0)
    r2 = crud.create_recipe(db_session, title="Dup", servings_default=1, course="main course", score=0)
